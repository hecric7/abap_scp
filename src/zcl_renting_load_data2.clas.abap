...
** Brands **
    ...
    ( marca = 'BENTLEY'      url ='https://www.autobild.es/sites/autobild.es/public/stSAP BTP - ABAP en CloudModelo de datos26yles/main_element/public/dc/fotos/Bentley-Continental_GT-2018-C01.jpg?itok=_kP_edH4')
...
** Cars **
    lt_cars = VALUE #(
        ...
        combustible = 'GASOLINA' consumo = '12.00' fecha_fabr = '20200924' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20211101' alq_hasta = '20221231' )
